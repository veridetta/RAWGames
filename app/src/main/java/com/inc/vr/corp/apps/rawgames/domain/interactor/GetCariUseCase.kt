...
class GetCariUseCase @Inject
constructor(
    useCaseExecutor: UseCaseExecutor,
    postExecutionThread: PostExecutionThread,
    repository: Repository
) : SingleUseCase<Models.BaseCari, CariModel>(useCaseExecutor, postExecutionThread, repository) {
    override fun interact(params: CariModel): Single<Models.BaseCari> {
        //return multiple models
        return repository.getCariUseCase(params)
    }
}